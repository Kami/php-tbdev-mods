...
$makeallfree = (int)$_GET['makeallfree'];
...
if ($makeallfree == 1)
{
mysql_query("UPDATE config SET value = '1' WHERE name = 'allfree'");
}

if ($makeallfree == 2)
{
mysql_query("UPDATE config SET value = '0' WHERE name = 'allfree'");
}
}
...
if ($allfree == 0)
{
echo "<input type=\"button\" value=\"Make all torrents freeleech\" onClick=\"parent.location='freeleech.php?makeallfree=1'\">";
}
else
{
echo "<input type=\"button\" value=\"Disable free leech for all torrents\" onClick=\"parent.location='freeleech.php?makeallfree=2'\">";
}
